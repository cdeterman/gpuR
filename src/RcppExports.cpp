...
// cpp_vclMatrix_eucl
void cpp_vclMatrix_eucl(SEXP ptrA, SEXP ptrD, int device_flag, const int type_flag);
...
// cpp_gpuMatrix_eucl
void cpp_gpuMatrix_eucl(SEXP ptrA, SEXP ptrD, int device_flag, const int type_flag);
