...
//    static arma::fmat Cm = as<arma::fmat>((NumericMatrix)C_);
    ...
    static const arma::imat A = arma::imat( (int*) xpA->matrix(),
                              xpA->nrow(),
                              xpA->ncol(),
                              false);
                              
    static const arma::imat B = arma::imat( (int*) xpB->matrix(),
                              xpB->nrow(),
                              xpB->ncol(),
                              false);
                              
    static arma::imat C = arma::imat( (int*) xpC->matrix(),
                              xpC->nrow(),
                              xpC->ncol(),
                              false);
                              
    static const arma::fmat Am = arma::conv_to<arma::fmat>::from(A);
    static const arma::fmat Bm = arma::conv_to<arma::fmat>::from(B);
    static arma::fmat Cm = arma::conv_to<arma::fmat>::from(C);
                              
//    static const arma::fmat Am = arma::fmat( (float*) &A[0],
//                              xpA->nrow(),
//                              xpA->ncol(),
//                              false);
//                              
//    static const arma::fmat Bm = arma::fmat( (float*) &B[0],
//                              xpB->nrow(),
//                              xpB->ncol(),
//                              false);
//                              
//    static arma::fmat Cm = arma::fmat( (float*) &C[0],
//                              xpC->nrow(),
//                              xpC->ncol(),
//                              false);
