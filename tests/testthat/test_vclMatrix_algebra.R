...
# test_that("vclMatrix Single Precision Matrix Vector Inplace Addition", {
#     
#     has_gpu_skip()
#     
#     C <- A + v
...
#     fvclV <- vclVector(v, type="float")
#     
#     fvclC <- gpuR:::vclMatVec_axpy(1, fvclA, fvclV, inplace = TRUE)
#     # fvclC2 <- fvclV - fvclA
#     
#     # expect_is(fvclC, "fvclMatrix")
#     expect_equal(fvclV[,], c(C), tolerance=1e-07, 
#                  info="float matrix elements not equivalent")  
#     # expect_equal(fvclC2[,], c(C2), tolerance=1e-07, 
#     #              info="float matrix elements not equivalent")  
# })
...
test_that("vclMatrix Single Precision matrix-vector crossprod", {
